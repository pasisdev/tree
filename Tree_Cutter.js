  ...
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DataLoaded = function (Event) {
      ...
      function DoStartWebAssembly() {
        ...
        $Self.StartWebAssembly("Tree_Cutter.wasm?random_suffix_to_avoid_cache=E221",true,rtl.createCallback($Self,"DoBeforeStart"),null);
      };
      var Xhr = null;
    ...
    this.DoRun = function () {
      var Xhr = null;
      var DataUrl = "";
      DataUrl = "Tree_Cutter_data.zip?random_suffix_to_avoid_cache=E221";
